			...
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
		 	...
		 	$( ".Depth03:contains('판매상품관리')" ).on("click" , function() {
				...
				//alert(  $( ".Depth03:contains('판매상품관리')" ) );
		 		$(window.parent.frames["rightFrame"].document.location).attr("href","/product/listProduct?menu=manage&orderby=");
			});
		 	
		 	$( ".Depth03:contains('상 품 검 색')" ).on("click" , function() {
				//Debug..
				//alert(  $( ".Depth03:contains('상 품 검 색')" ) );
		 		$(window.parent.frames["rightFrame"].document.location).attr("href","/product/listProduct?menu=search&orderby=");
			});
